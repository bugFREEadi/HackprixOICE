...
export default function SimulationPlaceholder() {
  return (
    <main data-testid={TID.simulationPlaceholder} className="relative min-h-screen bg-ink text-white grid place-items-center overflow-hidden px-6">
      <div className="absolute inset-0 bg-grid-premium mask-grid-v opacity-70" />
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-[600px] w-[600px] rounded-full blur-[180px] bg-pink/[0.12]" />
      ...
      >
        <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-3 py-1.5 text-[11px] uppercase tracking-[0.22em] text-bone/70 mb-7">
          <Play size={11} className="text-orange" fill="currentColor" /> Simulation engine
        </div>
        <h1 className="font-display text-5xl lg:text-6xl font-medium tracking-[-0.03em] leading-tight">
          The <span className="text-accent-warm font-semibold">90-second story</span> is loading.
        </h1>
        <p className="mt-6 text-bone/60 text-lg leading-relaxed">
          Interactive simulator: innovation creation, AI evaluation, escrow funding, milestone
          approval and automated reward distribution — narrated and step-controlled.
        </p>
        <Link
          to="/"
